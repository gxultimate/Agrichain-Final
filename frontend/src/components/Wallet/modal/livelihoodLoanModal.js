...
class LivelihoodLoan extends Component {
  ...
  getOnchange = value => {
    ...
    currentLoan.setProperty("typeOfLoan", "Livelihood Loan");
  };
...
const WrapLivelihoodLoanModal = Form.create()(LivelihoodLoan);
export default withRouter(
  inject("userStore")(observer(WrapLivelihoodLoanModal))
);
