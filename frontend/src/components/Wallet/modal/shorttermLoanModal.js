...
class ShortTermLoanModal extends Component {
  state = {
    visible: false,
    selectedFile: null
  };
  ...
  getOnchange = value => {
    ...
    currentLoan.setProperty("typeOfLoan", "Short-Term Loan");
  };
...
const WrapShortTermLoanModalModal = Form.create()(ShortTermLoanModal);
export default withRouter(
  inject("userStore")(observer(WrapShortTermLoanModalModal))
);
